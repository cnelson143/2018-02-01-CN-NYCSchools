...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    navBarProxy.barTintColor = [UIColor whiteColor];
    navBarProxy.tintColor = [UIColor blueColor];
    navBarProxy.titleTextAttributes = @{NSForegroundColorAttributeName:[UIColor blueColor]};
